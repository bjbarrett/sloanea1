...
model {
    ...
    for ( i in 1:N ) {
        ...
        if ( bout[i]==1 ) {
            ...
            beta_coho = ( mu[4] + a_id[id[i],4] );                             //contribution of cohort bias
            beta_age = ( mu[5] + a_id[id[i],5] );                             //contribution of age bias
            beta_kin = ( mu[6] + a_id[id[i],6] );                             //contribution of kin bias
