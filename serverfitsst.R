...
library(rethinking)
library(rstan)
#d <- read.csv("~/Dropbox/sloanea/oct7workableST.csv", na.strings = "" , stringsAsFactors=FALSE) #NA stuff helps with naomi
...
parlistQ=c("a_id" , "mu", "lambda" , "dev" , "log_lik")

fit_s = stan( file = 'ewa_freq_social.stan', data = datalist_s ,iter = 2000, warmup=1000, chains=4, cores= 4, pars=parlistF, control=list(adapt_delta=0.99))
fit_coho = stan( file = 'ewa_cue_social.stan', data = datalist_coho ,iter = 2000, warmup=1000, chains=4, cores= 4, pars=parlistQ, control=list(adapt_delta=0.99))
fit_age = stan( file = 'ewa_cue_social.stan', data = datalist_age ,iter = 2000, warmup=1000, chains=4, cores= 4, pars=parlistQ, control=list(adapt_delta=0.99))
fit_kin = stan( file = 'ewa_cue_social.stan', data = datalist_kin ,iter = 2000, warmup=1000, chains=4, cores= 4, pars=parlistQ, control=list(adapt_delta=0.99))
