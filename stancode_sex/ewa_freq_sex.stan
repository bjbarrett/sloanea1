   ...
   //priors
    ...
    for ( i in 1:n_obs ) {
        ...
        if ( bout[i]==1 ) {
            ...
            lambda[id[i]] = exp( I[id[i],1] + G[group_index[i],1] + S[sex_index[i] , 1]  ) ;
            phi[id[i]]= inv_logit(  I[id[i],2] + G[group_index[i],2]  + S[sex_index[i] , 2]  );
            gamma[id[i]] = inv_logit(  I[id[i],3] + G[group_index[i],3]  + S[sex_index[i] , 3]  );
            fc[id[i]] =  exp( I[id[i] , 4] + G[group_index[i] , 4]  + S[sex_index[i] , 4]  ) ;
        }
